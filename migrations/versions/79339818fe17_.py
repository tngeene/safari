...
Revision ID: 79339818fe17
Revises: 
Create Date: 2019-06-11 12:55:59.528022
...
def upgrade():
    ...
    sa.Column('logo', sa.String(length=120), nullable=True),
    sa.Column('banner', sa.String(length=120), nullable=True),
    sa.Column('physical_address', sa.String(length=120), nullable=True),
    sa.Column('postal_address', sa.String(length=120), nullable=True),
    sa.Column('association_membership', sa.String(length=120), nullable=True),
    sa.Column('rating', sa.Integer(), nullable=True),
    sa.Column('reg_certificate', sa.String(length=120), nullable=True),
    sa.Column('tax_registration', sa.String(length=120), nullable=True),
    sa.Column('operator_licence', sa.String(length=120), nullable=True),
