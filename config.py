...
class Config:
    APP_NAME = os.environ.get("APP_NAME") or "Safari"
    ...
    ADMIN_EMAIL = os.environ.get("ADMIN_EMAIL") or "tngeene@yahoo.com"
    ...
    # 1st User account
    USER_PASSWORD = os.environ.get("USER_PASSWORD") or "1con"
    USER_EMAIL = os.environ.get("USER_EMAIL") or "app.skye@gmail.com"
    ...
    RECAPTCHA_PUBLIC_KEY = (
        ...
        or "6LeYIbsSAAAAACRPIllxA7wvXjIE411PfdB2gt2J"
    )
    RECAPTCHA_PRIVATE_KEY = (
        os.environ.get("RECAPTCHA_PRIVATE_KEY")
        or "6LeYIbsSAAAAAJezaIq3Ft_hSTo0YtyeFG-JgRtu"
    )
